# Udacity-AI-Intel-Smart-Queuing-System
Smart Queuing System for Retails, Manufacturing and Transportation
...
### Manufactering
![Manufactering](./Images/Manufactering.png)
![Metrics](./Images/Manufacteringplot.png)
...
### Transportation
![Transportation](./Images/Retail.png)
...
* 6th to 10th generation Intel« CoreÖ processor with Iris« Pro graphics or Intel« HD Graphics.
* OR use of Intel« Neural Compute Stick 2 (NCS2)
* OR Udacity classroom workspace for the related course

### Software

*   Intel« Distribution of OpenVINOÖ toolkit 2019 R3 release
*   Node v6.17.1
*   Npm v3.10.10
*   CMake
*   MQTT Mosca server
...
### Install Intel« Distribution of OpenVINOÖ toolkit
...
You must configure the environment to use the Intel« Distribution of OpenVINOÖ toolkit one time per session by running the following command:
```
...
When running Intel« Distribution of OpenVINOÖ toolkit Python applications on the CPU, the CPU extension library is required. This can be found at: 
...
```
If you are in the classroom workspace, use the ôOpen Appö button to view the output. If working locally, to see the output on a web based interface, open the link [http://0.0.0.0:3004](http://0.0.0.0:3004/) in a browser.
